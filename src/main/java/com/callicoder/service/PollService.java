package com.callicoder.service;

import com.callicoder.config.service.UserPrincipal;
import com.callicoder.exception.BadRequestException;
import com.callicoder.exception.ResourceNotFoundException;
import com.callicoder.model.*;
...
import com.callicoder.util.ModelMapper;
...
public class PollService {
    ...
    public PagedResponse<PollResponse> getPollsVotedBy(String username , UserPrincipal currentUser , int page , int size){
        ...
        // Retrive all poll details from the voted pollIds
    ...
    public PollResponse getPollById(Long pollId , UserPrincipal currentUser){
        ...
        List<ChoiseVoteCount> votes = voteRepository.countByPollIdGroupByChoiseId(pollId);

        Map<Long , Long> choiceVoteMap = votes.stream()
                    .collect(Collectors.toMap(ChoiseVoteCount::getChoiseId , ChoiseVoteCount::getVoteCounte));
        //Retrieve poll creator details
        User creator = userRepository.findById(poll.getUpdatedBy())
                    .orElseThrow(() -> new ResourceNotFoundException("Poll" , "id" , poll.getCreatedBy()));
        //Retrive vote done by logged in user
        Vote userVote = null;
        if (currentUser != null){
    ...
    private Map<Long,Long> getChoiceVoteCountMap(List<Long> pollIds) {
        ...
        List<ChoiseVoteCount> votes = voteRepository.countByPollIdInGroupByChoiseId(pollIds);
